...
##Clock signal
set_property PACKAGE_PIN L16 [get_ports IO_CLK]
set_property IOSTANDARD LVCMOS33 [get_ports IO_CLK]
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports IO_CLK]

##Switches
##IO_L19N_T3_VREF_35
#set_property PACKAGE_PIN G15 [get_ports JTAG_TCK]
...
##IO_L4N_T0_34
#set_property PACKAGE_PIN W13 [get_ports JTAG_TRST_N]
#set_property IOSTANDARD LVCMOS33 [get_ports JTAG_TRST_N]

##IO_L9P_T1_DQS_34
#set_property PACKAGE_PIN T16 [get_ports JTAG_TDI]
#set_property IOSTANDARD LVCMOS33 [get_ports JTAG_TDI]

##Buttons
##IO_L20N_T3_34
#set_property PACKAGE_PIN R18 [get_ports JTAG_TDO]
#set_property IOSTANDARD LVCMOS33 [get_ports JTAG_TDO]

##IO_L24N_T3_34
#set_property PACKAGE_PIN P16 [get_ports JTAG_RESET_N]
#set_property IOSTANDARD LVCMOS33 [get_ports JTAG_RESET_N]
...
##IO_L7P_T1_34
set_property PACKAGE_PIN Y16 [get_ports IO_RST_N]
...
##Pmod Header JD
##IO_L5N_T0_34
set_property PACKAGE_PIN T15  [get_ports { JTAG_TDO }];
set_property IOSTANDARD LVCMOS33  [get_ports { JTAG_TDO }];

##IO_L5P_T0_34
set_property PACKAGE_PIN T14 [get_ports { JTAG_TRST_N }];
set_property IOSTANDARD LVCMOS33 [get_ports { JTAG_TRST_N }];

##IO_L6N_T0_VREF_34
set_property PACKAGE_PIN R14 [get_ports { JTAG_TCK }]; 
set_property IOSTANDARD LVCMOS33 [get_ports { JTAG_TCK }]; 

##IO_L6P_T0_34
#set_property PACKAGE_PIN P14 [get_ports JTAG_TDI]
#set_property IOSTANDARD LVCMOS33 [get_ports JTAG_TDI]

##IO_L11N_T1_SRCC_34
set_property PACKAGE_PIN U15 [get_ports { JTAG_TDI }];
set_property IOSTANDARD LVCMOS33 [get_ports { JTAG_TDI }];

##IO_L11P_T1_SRCC_34
set_property PACKAGE_PIN U14 [get_ports { JTAG_TMS }];
set_property IOSTANDARD LVCMOS33 [get_ports { JTAG_TMS }];

##IO_L21N_T3_DQS_34
set_property PACKAGE_PIN V18 [get_ports { JTAG_RESET_N }];
set_property IOSTANDARD LVCMOS33 [get_ports { JTAG_RESET_N }];
...
##Pmod Header JE
##IO_L4P_T0_34
set_property PACKAGE_PIN V12 [get_ports {SDA}]
